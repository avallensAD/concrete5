...
<div class="col-sm-5">
	...
	<div class="col-md-8">
	<?php echo $form->text('DB_SERVER', $connectstr_dbhost, array('class' => ''))?>
	</div>
	</div>
	...
	<div class="col-md-8">
		<?php echo $form->text('DB_USERNAME', $connectstr_dbusername, array('class' => ''))?>
	</div>
	</div>
	...
	<div class="col-md-8">
		<?php echo $form->password('DB_PASSWORD', $connectstr_dbpassword, array('class' => '', 'autocomplete' => 'off'))?>
	</div>
	</div>
