...
/* added for Azure Web Apps in-app MySQL */
$connectstr_dbhost = '';
$connectstr_dbname = '';
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo $form->text('DB_SERVER', $connectstr_dbhost, ['required' => 'required']) ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo $form->text('DB_USERNAME', $connectstr_dbusername) ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo $form->password('DB_PASSWORD', $connectstr_dbpassword, ['autocomplete' => 'off']) ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo $form->text('DB_DATABASE', $connectstr_dbname, ['required' => 'required']) ?>
                            </div>
                        </div>
                        </div>
                    </div>
